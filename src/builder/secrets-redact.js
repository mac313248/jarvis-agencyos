...
const SENSITIVE_KEY_RE =
  /^(?:CURSOR_API_KEY|CODEX_API_KEY|OPENAI_API_KEY|GITHUB_TOKEN|GH_TOKEN|GHL_.*|HIGHLEVEL_.*|META_.*|FACEBOOK_.*|STRIPE_.*|PAYMENT_.*|PAYPAL_.*|TWILIO_.*|.*(?:_KEY|_TOKEN|_SECRET|_PASSWORD|_PASSWD|_CREDENTIALS?))$/i;
